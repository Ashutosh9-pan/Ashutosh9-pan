...
<h1>Hi 👋, I'm Ashutosh Panwar</h1>

<h3>AI/ML Developer • Full-Stack Developer • Android Developer • Data Analyst</h3>

<p>
Computer Science Engineering graduate focused on building practical, production-ready software across AI, web, Android, and data.
</p>
...
🤖 Interested in AI/ML, Generative AI, LLMs, RAG, data analytics, and intelligent applications

🌐 Building full-stack applications with Next.js, Node.js, Express.js, MySQL, REST APIs, JWT, and RBAC

📱 Developing Android applications using Java, Firebase, SQLite, XML, and REST APIs

🚀 Experienced with deployment and developer workflows using Git, GitHub, Vercel, and Railway
